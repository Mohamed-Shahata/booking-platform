...
exports.deletetionExpiredUser = deletetionExpiredUser;
...
function deletetionExpiredUser() {
    node_cron_1.default.schedule("0 0 * * *", () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (usersToDelete.length === 0)
            return;
        yield Promise.all(usersToDelete.map((user) => __awaiter(this, void 0, void 0, function* () {
            var _a;
